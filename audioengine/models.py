...
class SimpleFeedForwardNetwork5():
    def __init__(self, num_classes: int = 0, input_length: int = 0):
        if(num_classess == 0 or input_length == 0):
            raise Exception('ModelDimensionException')
        super(SimpleFeedForwardNetwork15, self).__init__()
...
class Simple1DConvNet():
    def __init__(self, num_classes: int = 0, input_dimension: int = 0, conv_width: int = 3):
        if(num_classess == 0 or input_dimension == 0):
            raise Exception('ModelDimensionException')
        ...
        self_dropout_2 = tf.keras.layers.Dropout(0.25, name='dropout_2')
        ...
        self_dropout_3 = tf.keras.layers.Dropout(0.25, name='dropout_3')
